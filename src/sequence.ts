...
/**
 * Options accepted by the {@link Sequence} constructor.
 */
...
/**
 * The inclusive range of KSUIDs a {@link Sequence} can still produce.
 */
...
export class Sequence {
  ...
  public constructor(options: SequenceOptions) {
  ...
  public bounds(): SequenceBounds {
    ...
    const min = KSUID.fromBytes(this.withSequenceNumber(Buffer.from(seedBuffer), count));
    const max = KSUID.fromBytes(this.withSequenceNumber(Buffer.from(seedBuffer), 0xffff));
